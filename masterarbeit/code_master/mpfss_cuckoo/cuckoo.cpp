...
cuckoo_hashing * initialize(int w, int no_hash_tables, int *size_hash_tables, int *i_array, int max_loop){
	...
	c->hash_function= hashfuc_simple;
...
{ 	
		...
		printf("hashfuc_simple(1,1,10)=%d \n",hashfuc_simple(1, 1, 10 ));
		printf("hashfuc_simple(2,1,10)=%d \n",hashfuc_simple(2, 1, 10 ));
		printf("hashfuc_simple(3,1,10)=%d \n",hashfuc_simple(3, 1, 10 ));
		printf("hashfuc_simple(4,1,10)=%d \n",hashfuc_simple(4, 1, 10 ));
		printf("hashfuc_simple(5,1,10)=%d \n",hashfuc_simple(5, 1, 10 ));
		printf("hashfuc_simple(6,1,10)=%d \n",hashfuc_simple(6, 1, 10 ));
		printf("hashfuc_simple(7,1,10)=%d \n",hashfuc_simple(7, 1, 10 ));
	    return 0; 
} 
