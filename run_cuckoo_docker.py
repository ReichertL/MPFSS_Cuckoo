...
for i in range(0,6):
	...
	for i in range(0,30):
		command1="bazel run //code_master/mpfss_cuckoo:mpfss_cuckoo localhost:99999 1 "+str(t)+" "+str(n)
		command2="bazel run //code_master/mpfss_cuckoo:mpfss_cuckoo  localhost:99999 2 "+str(t)+" "+str(n)
		print(command1)
		print(command2)
